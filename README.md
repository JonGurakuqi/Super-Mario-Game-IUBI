...
[![Play](https://img.shields.io/badge/▶_PLAY-LIVE_DEMO-e45c10?style=for-the-badge&logo=nintendo-switch&logoColor=white)](https://jongurakuqi.github.io/super-iubi-bros/)
...
> ### 👉 **[CLICK HERE TO PLAY IN YOUR BROWSER](https://jongurakuqi.github.io/super-iubi-bros/)** 👈
...
**Goal:** Stomp the Goombas, grab the coins, beat the clock, and reach the flagpole.
...
```bash
git clone https://github.com/JonGurakuqi/super-iubi-bros.git
cd super-iubi-bros
```
Then double-click `super-iubi-bros.html`.
...
4. Click **Save**. Your game goes live at:
   ...
   ```
5. Rename `super-iubi-bros.html` to `index.html` so it loads automatically at the root URL.
